...
У начисления может не быть плательщика. Ребёнка приводят на занятие
раньше, чем регистрируется его родитель: занятие уже случилось, за него
могли отдать наличные, и всё это нужно записать. Такое начисление лежит с
пустым `owner_id`, в долгах ни у кого не числится и видно отдельным
предупреждением. Когда ребёнка привязывают к взрослому, начисления
переезжают на него вместе со своей ценой и оплатой: пересчитывать по
сегодняшней цене было бы враньём.
