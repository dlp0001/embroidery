...
Абонементов два: 4 занятия за 360 ₪ и 8 занятий за 680 ₪, оба на три
месяца. Цена пакета задана отдельно от цены занятия, а не выведена
умножением: в этом и смысл абонемента. Оба числа лежат в `settings`
(`studio_lesson_price` и `pass_types`), и цену меняют там, а не в коде.
...
| Абонементы | два: 4 занятия за 360 ₪ и 8 за 680 ₪, оба на три месяца |
