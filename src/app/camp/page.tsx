    ...
    <div className="lp">
      ...
      <section className="hero">
        <div className="hero-left">
          ...
          <p className="hero-desc">
            {camp
              ? `${period(camp)}, каждый день с ${hhmm(camp.starts_at)} до ${endsAt(camp)}. Пять часов, чтобы творить и делать невероятные штуки. А ещё это лагерь лайфхаков: будем чинить, шить, печь и готовить, разбирать и собирать.`
      ...
      {camp && days.length > 0 && (
        <section className="wrap">
          ...
          <p className="lead">
            В каждом дне и творчество, и что-нибудь полезное руками. Темы
            Варя допишет ближе к смене. Записаться можно уже сейчас: отметьте
            дни, в которые ребёнок придёт, отметку можно снять в любой момент.
          </p>
