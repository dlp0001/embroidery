      ...
      <div className="body">
        ...
        <div className="card">
          ...
          <p className="hint" style={{ marginBottom: 16 }}>
            ...
            он когда-то пришёл. Проще отвязать лишнего заранее: в «Людях» у
            каждого ребёнка есть кнопка «Отвязать», и запись без родителя
            спокойно ждёт наверху, в «Детях без родителя». Если склеили сразу —
            отвяжите сразу после: пока родителей двое, неясно, кому считать
            следующее занятие.
          </p>
